...
export default function LandingPage() {
  ...
  const faqs = [
    { q: 'Is AI Admission free to use?', a: 'Yes, we offer a free plan with essential features including limited SOP generation, profile analysis, university search, and AI chat.' },
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-black/80 backdrop-blur-lg">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6">
          <div className="flex items-center gap-2">
            <div className="h-9 w-9 rounded-xl bg-indigo-600 flex items-center justify-center font-bold text-base shrink-0">
              AI
            </div>
            <div>
              <h1 className="text-base font-bold leading-tight">AI Admission</h1>
      ...
      <section className="border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
          <div className="text-center">
            ...
            <h2 className="mt-4 text-3xl font-bold sm:text-4xl">Students Love Using AI Admission</h2>
          </div>
      ...
      <footer className="border-t border-white/10 bg-black">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-4 py-10 text-center sm:px-6 md:flex-row md:text-left">
          <div>
            <h3 className="text-lg font-bold">AI Admission</h3>
            <p className="mt-1 text-sm text-gray-500">Built by Ariesian Tech</p>
          </div>
