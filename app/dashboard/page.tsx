...
// ── Radial progress — teal/white palette ──────────────────────────────────────
    ...
    <div className="space-y-1.5">
      <div className="flex items-center justify-between">
        ...
        <span style={{
          ...
          color: exhausted ? '#E24B4A' : isPro ? '#1D9E75' : '#2C2C2A'
        }}>
          {isPro ? '∞' : `${used} / ${limit}`}
        </span>
      </div>
        ...
        <>
          <div style={{ height: 7, background: '#E1F5EE', borderRadius: 999, overflow: 'hidden' }}>
            <div style={{
              ...
              width: `${pct}%`,
              background: exhausted ? '#E24B4A' : warn ? '#EF9F27' : '#1D9E75',
...
export default function Dashboard() {
  ...
  useEffect(() => {
    // load Google Fonts for AdmitAI theme
    ...
    <div style={{ minHeight: '100vh', background: '#FFFBF5', ...base }}>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '28px 28px', display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16 }}>
          {statCards.map((c) => (
            <Link href={c.href} key={c.label} style={{ textDecoration: 'none' }}>
              <div style={{
                background: '#fff', borderRadius: 20, border: `1.5px solid ${c.border}`,
                padding: 22, cursor: 'pointer', transition: 'transform 0.18s, box-shadow 0.18s',
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
                  <div style={{ width: 48, height: 48, borderRadius: '50%', background: c.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>
                    {c.icon}
                  </div>
                  <svg width="16" height="16" fill="none" stroke={c.accent} viewBox="0 0 24 24" strokeWidth={2.5}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 3fr', gap: 16 }}>
          ...
          {/* Score card — deep teal hero */}
          <div style={{
            borderRadius: 20, overflow: 'hidden', position: 'relative', minHeight: 240,
            background: 'linear-gradient(145deg, #04342C 0%, #085041 50%, #1D9E75 100%)',
          }}>
            {/* Decorative orbs */}
            ...
            <div style={{ position: 'absolute', top: 18, left: 18 }}>
              <span style={{ background: '#EF9F27', color: '#412402', fontSize: 10, fontWeight: 800, padding: '4px 12px', borderRadius: 50, letterSpacing: '0.06em', textTransform: 'uppercase' }}>
                Profile Score
              </span>
            </div>
            ...
            <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              {!isPro && (
                <Link href="/checkout" style={{
                  ...
                  boxShadow: '0 4px 16px rgba(29,158,117,0.2)', marginTop: 4,
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          ...
          <Card>
            <CardHeader
              ...
              right={
                <Link href="/sop-history" style={{ fontSize: 12, color: '#1D9E75', fontWeight: 700, textDecoration: 'none' }}>
                  View All →
                </Link>
              }
            />
            <div>
              {recentGenerations.length === 0 ? (
                <div style={{ textAlign: 'center', padding: '40px 24px' }}>
                  ...
                  <Link href="/sop-generator" style={{ fontSize: 12, fontWeight: 700, color: '#1D9E75', textDecoration: 'none', display: 'inline-block', marginTop: 8 }}>
                ...
                recentGenerations.map((gen) => (
                  <div key={gen.id} style={{
                    ...
                    borderBottom: '1px solid #F0EDE6', transition: 'background 0.15s',
                  }}
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <p style={{ fontSize: 13, fontWeight: 700, color: '#085041', margin: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                    ...
                    <span style={{
                      ...
                      background: '#E1F5EE', color: '#0F6E56', border: '1.5px solid #9FE1CB', flexShrink: 0,
                    }}>
        ...
        {profile && !isPro && (
          <div style={{
            borderRadius: 20, overflow: 'hidden', position: 'relative', minHeight: 130,
            background: 'linear-gradient(120deg, #04342C 0%, #085041 55%, #1D9E75 100%)',
          }}>
            {/* Amber glow right */}
            ...
            <div style={{ position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '28px 32px' }}>
              <div>
                <div style={{ display: 'inline-block', background: '#EF9F27', color: '#412402', fontSize: 10, fontWeight: 800, padding: '4px 12px', borderRadius: 50, marginBottom: 10, letterSpacing: '0.06em', textTransform: 'uppercase' }}>
                  Limited Time Offer
                </div>
                <h3 style={{ fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: 22, fontWeight: 700, color: '#fff', margin: 0, lineHeight: 1.2 }}>
                  Unlock Pro — PKR 800/month
                </h3>
                <p style={{ color: '#9FE1CB', fontSize: 13, marginTop: 6, fontWeight: 600 }}>
                  Unlimited SOPs, analyses, AI chat & more. 7-day free trial.
                </p>
              </div>
              <Link href="/checkout" style={{
                ...
                textDecoration: 'none', boxShadow: '0 4px 20px rgba(239,159,39,0.35)',
