...
export default function Dashboard() {
  ...
  const loadSupabaseData = async () => {
    ...
    if (genData) setRecentGenerations(genData);
  };
  ...
  const statCards = [
    { label: 'SOPs Generated',      value: stats.sopsGenerated,        icon: '📝', bg: 'bg-blue-50',    border: 'border-blue-100',    text: 'text-blue-700',    hint: 'Go to SOP Generator →',  href: '/sop-generator' },
    { label: 'University Searches', value: stats.universitiesSearched, icon: '🏛️', bg: 'bg-amber-50',   border: 'border-amber-100',   text: 'text-amber-700',   hint: 'Find Universities →',    href: '/university-finder' },
    { label: 'Profiles Analyzed',   value: stats.profilesAnalyzed,     icon: '📊', bg: 'bg-emerald-50', border: 'border-emerald-100', text: 'text-emerald-700', hint: 'Analyze Profile →',      href: '/profile-analyzer' },
    { label: 'Chat Messages',       value: stats.chatMessages,         icon: '💬', bg: 'bg-violet-50',  border: 'border-violet-100',  text: 'text-violet-700',  hint: 'Open AI Chat →',         href: '/chatbot' },
  ];
